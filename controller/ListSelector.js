sap.ui.define([
		...
		return BaseObject.extend("pt.ewm.am.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias pt.ewm.am.model.ListSelector
			 */
			 ...
			 * @return {pt.ewm.am.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
